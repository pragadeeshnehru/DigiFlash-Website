...
export default function Header() {
  return (
    <header className="font-display w-full z-20 flex flex-wrap justify-between items-center py-6 px-6 md:py-8 md:px-12 bg-[rgb(0,0,0)] text-white">
      <div className="w-full md:w-auto text-3xl md:text-4xl font-bold text-center md:text-left bg-gradient-to-r bg-clip-text from-[#ffaa2b] to-[#02c222] text-transparent">
        DigiFlash
      </div>
