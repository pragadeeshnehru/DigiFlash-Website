...
export const MacbookScroll = ({ src, showGradient, title, badge }) => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0  md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.65]"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-[#ffffff] rounded-2xl p-2 relative"
      >
        <div
          style={{
            boxShadow: "0px 2px 0px 2px #2a2a2a inset",
          }}
...
const MCETLogo = () => {
  return (
    <img
      src="https://mcet.in/mca/ETech2020/img/logo-2.png"
      alt="MCET Logo"
      width="70"
      height="85"
      className="scale-[1.5] "
