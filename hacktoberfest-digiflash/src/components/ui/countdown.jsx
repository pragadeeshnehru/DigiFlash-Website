  ...
  return (
    <div className="flex items-start justify-center w-full gap-4 count-down-main">
      <div className="timer w-16">
        ...
        <p className="text-lg font-Cormorant font-medium text-gray-400 mt-1 text-center w-full">days</p>
      </div>
      
      <h3 className="font-manrope font-semibold text-2xl text-gray-400 pt-3">:</h3>
      ...
      <div className="timer w-16">
        ...
        <p className="text-lg font-Cormorant font-normal text-gray-400 mt-1 text-center w-full">hours</p>
      </div>
      ...
      <div className="timer w-16">
        ...
        <p className="text-lg font-Cormorant font-normal text-gray-400 mt-1 text-center w-full">minutes</p>
      </div>
      ...
      <div className="timer w-16">
        ...
        <p className="text-lg font-Cormorant font-normal text-gray-400 mt-1 text-center w-full">seconds</p>
      </div>
    </div>
  );
};
